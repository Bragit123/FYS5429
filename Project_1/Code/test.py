...
plt.figure()
plt.title("Output vs predict")
plt.plot(scores["train_output"], scores["train_predict"], ".", label="Training")
plt.plot(scores["val_output"], scores["val_predict"], ".", label="Validation")
plt.xlabel("Epoch")
plt.ylabel("Error")
plt.legend()
